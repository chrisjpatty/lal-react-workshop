...
# Users expect web pages to be<br/><Hi>feature-rich</Hi>,<br/><Hi>fast</Hi>,<br/>and <Hi>highly dynamic</Hi>
...
<Big style={{transform: 'translateY(15%)'}}>State Managment</Big>
...
## That's an <Hi>impossible</Hi> number<br/>of possible states to account for<br/>using <Hi>traditional methods</Hi>

<img src="https://media.giphy.com/media/BmmfETghGOPrW/giphy.gif" style={{width: '30vw'}} />

---

# How does <Hi>React</Hi> solve this problem?
...
# React-powered user interfaces are a<br/><Hi>pure function</Hi> of the<br/><Hi>state</Hi> of your application
...
<FullsizeSandbox>
  <iframe
    src="https://codesandbox.io/embed/restless-cherry-o73ru?fontsize=28&hidenavigation=1"
    title="hooks-demo" allow="geolocation; microphone; camera; midi; vr; accelerometer; gyroscope; payment; ambient-light-sensor; encrypted-media"
